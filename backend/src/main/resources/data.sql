...
('러닝', '유산소'), ('헬스', '근력운동'), ('풋살', '구기종목'), ('농구', '구기종목'),
...
(2, 3, 1, '운정 풋살장 토요일 저녁 경기', '초중급 풋살 경기 인원 모집합니다.', '운정 스포츠파크', '2026-05-17', '18:30:00', 10, 'RECRUITING'),
(1, 2, 3, '헬린이 루틴 공유 모임', '초보자 루틴 공유 및 상호 피드백.', '금촌동 피트니스센터', '2026-05-15', '19:00:00', 5, 'RECRUITING'),
(3, 5, 4, '문산 실내체육관 초급 배드민턴', '초급 배드민턴 랠리 모임.', '문산 실내체육관', '2026-05-18', '14:00:00', 8, 'RECRUITING'),
(2, 6, 1, '심학산 둘레길 아침 산책 모임', '가볍게 걷는 등산 모임입니다.', '심학산 입구', '2026-05-17', '08:00:00', 6, 'CLOSED');
